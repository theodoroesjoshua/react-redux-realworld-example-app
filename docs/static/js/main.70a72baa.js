...
!(function () {
  var e = {
      ...
      8267: function (e, t, n) {
        ...
        var u = (0, r.hg)('article/getArticle', i.Z.Articles.get),
          c = (0, r.hg)('article/createArticle', i.Z.Articles.create, {
            serializeError: l,
          }),
          s = (0, r.hg)('article/updateArticle', i.Z.Articles.update, {
            serializeError: l,
          }),
          f = {
            article: void 0,
          ...
          d = (0, r.oM)({
            ...
            extraReducers: function (e) {
              e.addCase(a.ZN.fulfilled, function (e, t) {
                (e.article.author = t.payload.profile), (e.inProgress = !1);
              }),
                e.addCase(a.fv.fulfilled, function (e, t) {
                  (e.article.author = t.payload.profile), (e.inProgress = !1);
                }),
                e.addCase(o.TD.fulfilled, function (e, t) {
                  (e.article = t.payload.article), (e.inProgress = !1);
                }),
                e.addCase(o.tj.fulfilled, function (e, t) {
                  (e.article = t.payload.article), (e.inProgress = !1);
                }),
                ...
                e.addCase(c.rejected, function (e, t) {
                  (e.errors = t.error.errors), (e.inProgress = !1);
                }),
                e.addCase(s.fulfilled, function (e) {
                  e.inProgress = !1;
                }),
                e.addCase(s.rejected, function (e, t) {
                  (e.errors = t.error.errors), (e.inProgress = !1);
                }),
                e.addMatcher(
                  function (e) {
          ...
          p = d.actions.articlePageUnloaded;
        t.ZP = d.reducer;
      },
      1858: function (e, t, n) {
        'use strict';
      ...
      9829: function (e, t, n) {
        ...
        function Fe(e) {
          ...
          var v = he.apply(void 0, h),
            m = pe;
          c && (m = Te(Ne({ trace: !1 }, 'object' === typeof c && c)));
          var y = new Re(v),
            g = y;
          return (
            Array.isArray(p)
        ...
        function Qe(e, t, n) {
          for (var r = [], a = [], o = 0, i = (e = qe(e)); o < i.length; o++) {
            var l = i[o],
              u = Ve(l, t);
        ...
        function Ke(e) {
          ...
          function n(e, n) {
            for (var r = 0, a = (e = qe(e)); r < a.length; r++) {
              t(a[r], n);
            }
          }
          function r(t, n) {
          ...
          return {
            ...
            setMany: Be(function (e, t) {
              for (var n = 0, a = (e = qe(e)); n < a.length; n++) {
                r(a[n], t);
              }
            }),
            setAll: Be(function (e, t) {
              (e = qe(e)), (t.ids = []), (t.entities = {}), n(e, t);
            }),
          ...
          var t = Ne(
            ...
            i = r
              ? (function (e, t) {
                  var n = Ke(e);
                  function r(t, n) {
                    var r = (t = qe(t)).filter(function (t) {
                      return !(Ve(t, e) in n.entities);
                    });
                    0 !== r.length && l(r, n);
                  }
                  function a(e, t) {
                    0 !== (e = qe(e)).length && l(e, t);
                  }
                  function o(t, n) {
          ...
          var s = (function (e, t) {
              ...
              var n = 'string' === typeof e ? N(e) : e,
                ...
                u = r
                  ...
                  : t;
              return { pathname: u, search: B(o), hash: V(l) };
            })(a, o),
            f = l && '/' !== l && l.endsWith('/'),
            d = (i || '.' === l) && n.endsWith('/');
          return (
      ...
      6038: function (e, t, n) {
        ...
        var Le = Math.random().toString(36).slice(2),
          Te = '__reactFiber$' + Le,
          Ae = '__reactProps$' + Le,
          ze = '__reactContainer$' + Le,
          Re = '__reactEvents$' + Le,
          De = '__reactListeners$' + Le,
          Me = '__reactHandles$' + Le,
          Fe = '__reactResources$' + Le,
          Ie = '__reactMarker$' + Le;
        function Ue(e) {
          delete e[Te], delete e[Ae], delete e[Re], delete e[De], delete e[Me];
        }
        function $e(e) {
          var t = e[Te];
          if (t) return t;
        ...
        function Dt(e, t, n) {
          ...
          try {
            ...
            if (
              ((Rt = !1),
              (null !== Tt || null !== At) &&
                ($c(), Tt && ((t = Tt), (e = At), (At = Tt = null), zt(t), e)))
            )
        ...
        function Ar(e) {
          if (50 < Tc) throw ((Tc = 0), (Ac = null), Error(i(185)));
        ...
        function eo(e) {
          if (e === Ba || e === qa) throw Error(i(483));
        }
        var to = !1;
        function no(e) {
          e.updateQueue = {
        ...
        function To(e, t, n, r, a, o) {
          return (
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (z.H = null === e || null === e.memoizedState ? Vi : qi),
            (Co = !1),
            (o = n(r, a)),
            (Co = !1),
            Eo && (o = zo(t, n, r, a)),
        ...
        function $o(e) {
          ...
          return (
            ...
            null === (null === ko ? t.memoizedState : ko.next) &&
              ((t = t.alternate),
              (z.H = null === t || null === t.memoizedState ? Vi : qi)),
            e
          );
        }
        function Zo(e) {
        ...
        function ti(e, t, n, r) {
          return (e.baseState = n), Vo(e, So, 'function' === typeof r ? r : Wo);
        }
        ...
        function yi(e, t, n, r) {
          ...
          null !== So && null !== r && Lo(r, So.memoizedState.deps)
          ...
          if (null !== (u = e.memoizedState) && null !== (c = u.dehydrated)) {
            if (l)
              ...
              if (
                ...
                throw ((u.retryLane = a), Lr(e, a), Dc(r, e, a), Pl);
              '$?' === c.data || qc(), (t = Bl(e, t, n));
            } else
              '$?' === c.data
        ...
        function Xl(e, t, n) {
          ...
          else (Ol = !1), oa && 0 !== (1048576 & t.flags) && ea(t, qr, t.index);
          switch (((t.lanes = 0), t.tag)) {
                ...
                null === e
                  ? (n = _f(t.type, null, t.pendingProps, null))
                    ...
                    : oa ||
                      ((n = t.type),
                      (e = t.pendingProps),
                      ((r = rf(W.current).createElement(n))[Te] = t),
                      (r[Ae] = e),
                      ef(r, n, e),
                      Be(r),
                      (t.stateNode = r))
            ...
            case 5:
              return (
                ...
                null !== t.memoizedState &&
                  ((a = To(e, t, Ro, null, null, n)), (Kf._currentValue = a)),
                zl(e, t),
                Nl(e, t, r, n),
                t.child
              );
        ...
        function ru(e, t, n) {
          ...
          switch ((na(t), t.tag)) {
            ...
            case 6:
              if (e && null != t.stateNode) e.memoizedProps !== r && Yl(t);
                ...
                if (((e = W.current), da(t))) {
                  ...
                  ((e = rf(e).createTextNode(r))[Te] = t), (t.stateNode = e);
              }
              return nu(t), null;
            case 13:
              if (
            ...
            case 4:
              return (
                q(), null === e && Us(t.stateNode.containerInfo), nu(t), null
              );
            case 10:
        ...
        function Qu(e) {
          switch (e.tag) {
            ...
            case 4:
              var t = Au;
              (Au = Cf(e.stateNode.containerInfo)), qu(e), (Au = t);
              break;
            case 22:
              null === e.memoizedState &&
        ...
        function ps(e, t) {
          0 === t && (t = xe()), null !== (e = Lr(e, t)) && (Ce(e, t), ks(e));
        }
        function hs(e) {
          var t = e.memoizedState,
            n = 0;
          ...
          S: function (e, t, n) {
            ...
            if (r && e) {
              ...
              if (!i) {
                ...
                if ((i = r.querySelector(Lf(o)))) l.loading = 5;
                else {
                  (e = d(
                ...
                if (null !== o)
                  switch (o.tag) {
                    case 3:
                      ...
                      break;
                    case 13:
                      null !== (l = Lr(o, 2)) && Dc(l, 0, 2), $c(), td(o, 2);
                  }
        ...
        var Ld = a.version;
        if ('19.1.0' !== Ld) throw Error(i(527, Ld, '19.1.0'));
  ...
  !(function () {
      ...
      return e
        ? (0, l.jsx)('li', {
            ...
            children: (0, l.jsxs)('button', {
              ...
              children: [(0, l.jsx)('i', { className: 'ion-pound' }), ' ', e],
            }),
          })
        : null;
    }
    ...
    var v = (0, r.memo)(h),
          ...
          g().mark(function e() {
            ...
            return g().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (e.next = 2), w.Z.Tags.getAll();
                  case 2:
      ...
      x = { status: S.qb.IDLE, tags: [] },
      E = (0, b.oM)({
        name: 'tags',
        initialState: x,
        reducers: {},
        extraReducers: function (e) {
          e.addCase(k.pending, function (e) {
            e.status = S.qb.LOADING;
          }).addCase(k.fulfilled, function (e, t) {
            return { status: S.qb.SUCCESS, tags: t.payload };
          });
        },
      }),
      C = function (e) {
    ...
    function _() {
      ...
      return (0, l.jsxs)('div', {
        className: 'sidebar',
        children: [
          (0, l.jsx)('p', { children: 'Popular Tags' }),
          (0, l.jsx)('div', {
            className: 'tag-list',
            children: a
              ? (0, l.jsx)('p', { children: 'Loading Tags...' })
              : n.map(function (e) {
                  return (0,
                  l.jsx)('button', { type: 'button', className: 'tag-default tag-pill', onClick: i(e), children: e }, e);
                }),
          }),
        ],
      });
    ...
    function D() {
      ...
      return (0, l.jsxs)('ul', {
        ...
        children: [
          ...
          (0, l.jsx)('li', {
            className: 'nav-item',
            children: (0, l.jsxs)(z.rU, {
              to: '/editor',
              className: 'nav-link',
              children: [
                (0, l.jsx)('i', { className: 'ion-compose' }),
                '\xa0New Post',
              ],
            }),
          }),
          (0, l.jsx)('li', {
            ...
            children: (0, l.jsxs)(z.rU, {
              ...
              className: 'nav-link',
              children: [
                (0, l.jsx)('i', { className: 'ion-gear-a' }),
                '\xa0Settings',
              ],
            }),
          }),
    ...
    var F = (0, r.memo)(M),
      I = (0, r.lazy)(function () {
        return Promise.all([n.e(644), n.e(951)]).then(n.bind(n, 9819));
      }),
      U = (0, r.lazy)(function () {
        ...
        o
          ? (0, l.jsxs)(l.Fragment, {
              children: [
                (0, l.jsx)(F, {}),
                (0, l.jsx)(r.Suspense, {
                  fallback: (0, l.jsx)('p', { children: 'Loading...' }),
                  children: (0, l.jsxs)(a.Z5, {
                    children: [
                      (0, l.jsx)(a.AW, {
                        exact: !0,
                        path: '/',
                      ...
                      (0, l.jsx)(a.AW, {
                        path: '/register',
                        element: (0, l.jsx)($, { isRegisterScreen: !0 }),
                      }),
                      (0, l.jsx)(a.AW, {
                        path: '/editor/:slug',
                        element: (0, l.jsx)(U, {}),
                      ...
                      (0, l.jsx)(a.AW, {
                        ...
                        element: (0, l.jsx)(Z, { isFavoritePage: !0 }),
                      }),
                      (0, l.jsx)(a.AW, {
                        path: '/:username',
                        element: (0, l.jsx)(Z, {}),
    ...
    var ae = function (e) {
        return function (e) {
          return function (t) {
            switch (t.type) {
              case i.z2.fulfilled.type:
              case i.x4.fulfilled.type:
                window.localStorage.setItem('jwt', t.payload.token),
                  w.Z.setToken(t.payload.token);
                break;
              case i.kS.type:
                window.localStorage.removeItem('jwt'), w.Z.setToken(void 0);
            }
            return e(t);
          };
        };
    ...
    var le,
      ue = (0, b.xC)({
        ...
        middleware: function (e) {
          return [].concat((0, q.Z)(e()), [ae]);
        },
      });
    (0, e.createRoot)(document.getElementById('root')).render(
      (0, l.jsx)(r.StrictMode, {
        children: (0, l.jsx)(t.zt, {
          store: ue,
          children: (0, l.jsx)(z.VK, { children: (0, l.jsx)(V, {}) }),
        }),
      })
    ),
